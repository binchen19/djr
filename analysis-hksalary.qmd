...
**What you'll learn:**
- Transform raw statistics into story angles
- Recognize patterns that signal newsworthy trends
- Compare groups to find inequality or change
- Use data exploration to generate questions instead of just reporting answers
