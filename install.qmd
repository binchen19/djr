...
1.  Create a project folder:
    ...
    -   Linux: `/home/[YourName]/Documents/djr`
...
Download the full [RStudio IDE cheatsheet](cheatsheets/rstudio-ide.pdf)
...
Download the full [RMarkdown cheatsheet](cheatsheets/rmarkdown.pdf)
...
|-------------------------|-----------------------------|------------------|
| Insert code chunk (Windows, Linux) | `Ctrl + Alt + I` | \- |
