...
Chapter 5 calculated and checked several findings. We will now turn those
tables into charts. Every chart begins with a reporting question and a plan;
...
Open `djr.Rproj` and create `06-basic-visualization.Rmd`. Reuse the combined
file created in Chapter 5. A ready-made
...
though the smaller observations are crowded together. Chapter 7 will add a
...
one variable caused the other. Chapter 7 will address overlapping points,
